package com.lyx.lyx_app_upgrade
...
/** LyxAppUpgradePlugin */
class LyxAppUpgradePlugin: FlutterPlugin, MethodCallHandler, ActivityAware {
  ...
  override fun onAttachedToEngine(@NonNull flutterPluginBinding: FlutterPlugin.FlutterPluginBinding) {
    channel = MethodChannel(flutterPluginBinding.binaryMessenger, "lyx_app_upgrade")
  ...
  companion object {
    ...
    fun registerWith(registrar: Registrar) {
      ...
      val channel = MethodChannel(registrar.messenger(), "lyx_app_upgrade")
      channel.setMethodCallHandler(LyxAppUpgradePlugin())
    }
