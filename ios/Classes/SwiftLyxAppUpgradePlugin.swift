...
public class SwiftLyxAppUpgradePlugin: NSObject, FlutterPlugin {
  public static func register(with registrar: FlutterPluginRegistrar) {
    let channel = FlutterMethodChannel(name: "lyx_app_upgrade", binaryMessenger: registrar.messenger())
    let instance = SwiftLyxAppUpgradePlugin()
